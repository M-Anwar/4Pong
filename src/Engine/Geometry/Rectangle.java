 ...
 * doing collision detection with other object (Calculate vertices),
 * however one could use it to just store generic rectangle data, 
 * however then one must not rely on using any of the collision constructs.
